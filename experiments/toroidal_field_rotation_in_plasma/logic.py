...
def run(cfg: dict, medium: Medium):
    out_root = cfg.get("output_dir", "output/toroidal_field_rotation_in_plasma")
    ...
    # plasma screening at the drive frequency
    ...
    for name in names:
        ...
        save_plot(
            t_arr, trace,
            title=f"Toroidal Force vs Time — {name.capitalize()} (Plasma)",
