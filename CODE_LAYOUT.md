# Vireon Code Layout (Index)

This documentation describes the structure and logic of the Vireon Virtual Lab repository, split across modular sections for clarity.

## Sections

- [Code Layout Overview](docs/layout_parts/code_layout_overview.md)
- [Code Layout Core Modules](docs/layout_parts/code_layout_core_modules.md)
- [Code Layout Experiments](docs/layout_parts/code_layout_experiments.md)
- [Code Layout Interface](docs/layout_parts/code_layout_interface.md)
- [Code Layout Output Handling](docs/layout_parts/code_layout_output_handling.md)
- [Code Layout Entry And Config](docs/layout_parts/code_layout_entry_and_config.md)

---

## Folder Tree (Top-Level Layout)
